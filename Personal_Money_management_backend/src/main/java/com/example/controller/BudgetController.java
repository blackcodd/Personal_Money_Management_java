...
public class BudgetController {
   ...
   {
        try {
            budgetService.setBudget(userId, startDate, endDate,amount);
    ...
    @GetMapping("/check")
    public ResponseEntity<Map<String, Boolean>> checkBudget(@AuthenticationPrincipal Long userId) {
    ...
    public ResponseEntity<String> deleteBudget(@AuthenticationPrincipal Long userId) {
        try {
